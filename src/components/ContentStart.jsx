...
export default function ContentStart() {
  return (
    <div className='flex relative h-150 bg-orange-500'>
        ...
        <span className='mt-20 ml-15 text-white text-5xl font-bold z-30 w-150   '>Trouvez & vendre la voiture de vos choix</span>
        
        <div className='flex z-30 w-150 mt-20 h-full flex-col-reverse'>
